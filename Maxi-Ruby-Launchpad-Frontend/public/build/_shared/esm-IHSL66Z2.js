...
import {
  ...
  y as y2,
  y2 as y3
} from "/build/_shared/chunk-QMY2EA2J.js";
import {
  detect,
  init_es,
  require_cjs,
...
} from "/build/_shared/chunk-D75XROR7.js";
import {
  __commonJS,
  __esm,
  __export,
...
function x2(n, e) {
  ...
  function u(e2) {
    return this.shouldComponentUpdate = r, y2(n, e2);
  }
...
function j(n) {
  ...
  } }), D(y2(P2, { context: e.context }, n.__v), e.l);
}
function z(n, e) {
  var r = y2(j, { __v: n, i: e });
...
var init_compat_module = __esm({
  "node_modules/preact/compat/dist/compat.module.js"() {
    ...
    l.unmount = function(n) {
      ...
      var i = e.__a && y2(k, null, n.fallback);
      return i && (i.__h = null), [y2(k, null, e.__a ? null : n.children), i];
    };
    W = function(n, t, e) {
    ...
    gn = y3;
    Cn = an;
    wn = { useState: h, useId: V, useReducer: s, useEffect: p, useLayoutEffect: y3, useInsertionEffect: gn, useTransition: Sn, useDeferredValue: bn, useSyncExternalStore: En, startTransition: _n, useRef: _2, useImperativeHandle: A, useMemo: F2, useCallback: T, useContext: q, useDebugValue: x, version: "17.0.2", Children: O, render: G2, hydrate: J, unmountComponentAtNode: vn, createPortal: z, createElement: y2, createContext: G, createFactory: fn, cloneElement: hn, createRef: _, Fragment: k, isValidElement: an, isElement: Cn, isFragment: sn, findDOMNode: dn, Component: b, PureComponent: w, memo: x2, forwardRef: k2, flushSync: mn, unstable_batchedUpdates: pn, StrictMode: yn, Suspense: U, SuspenseList: V2, lazy: M, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: ln };
  }
});
...
//# sourceMappingURL=/build/_shared/esm-IHSL66Z2.js.map
